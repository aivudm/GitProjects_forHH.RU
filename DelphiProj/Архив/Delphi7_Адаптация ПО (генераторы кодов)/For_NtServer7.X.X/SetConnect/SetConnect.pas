...
const
     ...
     OffsToNumUser_ForVers_760: byte = $29;
     ImageVersion_700: String = '7.0.0';
     ImageVersion_751: String = '7.5.1';
     ImageVersion_760: String = '7.6.0';
...
if MyVersionSQLServer= ImageVersion_760 then
 Result:= OffsToNumUser_ForVers_751;
end;
...
if not FlagCrack then
 ...
 begin
   MessageDlg('Max Number of user is seted succesful',
              mtInformation,[mbOK],0);
      if IsDigit(GetNumUser) then         
       begin
        if StrToInt(GetNumUser)<>0 then
          Form1.Label4.Caption:= GetNumUser
        else
          Form1.Label4.Caption:= 'Not Limited';
       end
