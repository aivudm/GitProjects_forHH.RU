 ...
 for numCurrentTSFParam:= 1 to TSFParamCount do
  begin
    ...
    if arrayNameTSFParam[numCurrentTSFParam] <> '' then
     form1.RichEdit1.Lines.Add('*******Параметр № ' + IntToStr(numCurrentTSFParam) + ' {' + arrayNameTSFParam[numCurrentTSFParam] + '}')
    else
     form1.RichEdit1.Lines.Add('*******Параметр № ' + IntToStr(numCurrentTSFParam));
