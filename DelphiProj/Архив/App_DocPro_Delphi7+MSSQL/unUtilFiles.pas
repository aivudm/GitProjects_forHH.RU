...
function OpenFileToMemory(MyNameFile: String; var Buffer: Pointer;MySizeOfFile:LongInt): boolean;
...
//################## OpenFileToMemory ########################
function OpenFileToMemory(MyNameFile: String; var Buffer: Pointer;
